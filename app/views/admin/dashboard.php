...
<body>
    ...
    <section class="flex items-center relative">
        ...
        <!-- Dashboard -->
        <div class="w-[70vh] md:w-[80vw] h-[100vh] bg-gray-400 py-[50px] px-8" >
            
            <!-- Page Head -->
            <div>
                <h1 class="text-md md:text-xl lg:text-3xl font-[800] mb-8">ADMIN / Dashboard</h1>
                <div class="w-full bg-gray-100 border-2 border-gray-900 rounded py-8 px-4">
            ...
            <div class="mt-8 bg-gray-400 flex flex-wrap justify-between gap-4">

                <div class="w-[45%] md- bg-gray-400/30 rounded p-8 rounded  border-2 border-gray-800 text-center" >
                ...
                <div class="w-[45%] bg-gray-400/30 rounded p-8 rounded  border-2 border-gray-800 text-center" >
                ...
                <div class="w-[100%] md:w-[45%] bg-gray-400/30 rounded p-8 rounded  border-2 border-gray-800 text-center" >
