    ...
    <section>
        <div class="w-[90%] mx-auto mt-[60px] mb-[90px]">
            ...
            <div class="w-full flex-col flex justify-center items-center mt-4 gap-y-2">
                <input type="search" name="searchInput" placeholder="Search Category"
                    class="w-[90%] lg:w-[50%] px-[20px] border-2 border-[#415a77] rounded h-[40px] placeholder:text-[#415a77] outline-none">

                <div>
                    <button
                        class="py-[5px] px-4 bg-[#415a77] text-white border-2 border-[#415a77] rounded hover:bg-[#415a77]/50 hover:text-[#415a77] focus:bg-[#284b63] focus:text-white">Order
                        By Date</button>
                    <button
                        class="py-[5px] px-4 bg-[#415a77] text-white border-2 border-[#415a77] rounded hover:bg-[#415a77]/50 hover:text-[#415a77] focus:bg-[#284b63] focus:text-white">Order
                        By Name</button>
            ...
            <div
                class="flex items-center justify-center flex-col flex-wrap gap-x-[20px] gap-y-[10px] mt-[30px] md:flex-row">
